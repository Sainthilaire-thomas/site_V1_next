...
async function getAccessoires(): Promise<Product[]> {
...
export default async function AccessoiresPage() {
  const products = await getAccessoires()
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-hero mb-4">ACCESSOIRES</h1>
          <p className="text-body text-grey-medium max-w-md">
            Sacs, bijoux et pièces pour parfaire votre style
          </p>
        </div>
      </section>
      ...
      <div className="sticky top-20 z-40 bg-white/95 backdrop-blur-md border-b border-grey-light py-4 px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex gap-6 overflow-x-auto">
            ...
            <FilterButton>SACS</FilterButton>
            <FilterButton>BIJOUX</FilterButton>
            <FilterButton>CEINTURES</FilterButton>
            <FilterButton>ÉCHARPES</FilterButton>
          </div>
