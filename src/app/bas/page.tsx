...
async function getBas(): Promise<Product[]> {
  ...
  const { data, error } = await supabase
    ...
    .eq('is_active', true)
    .in('category.name', ['Bas', 'Pantalons', 'Jeans', 'Jupes', 'Shorts'])
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-hero mb-4">BAS</h1>
          <p className="text-body text-grey-medium max-w-md">
            Pantalons, jupes et pièces intemporelles
          </p>
        </div>
      </section>
      ...
      <div className="sticky top-20 z-40 bg-white/95 backdrop-blur-md border-b border-grey-light py-4 px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex gap-6 overflow-x-auto">
            ...
            <FilterButton>PANTALONS</FilterButton>
            <FilterButton>JEANS</FilterButton>
            <FilterButton>JUPES</FilterButton>
            <FilterButton>SHORTS</FilterButton>
          </div>
